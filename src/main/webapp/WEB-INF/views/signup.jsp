...
<div class="container">
    ...
    <div class="col-md-8">
      ...
      <!--   <hr> -->
            <form:form action="signupPage" commandName="UserProfileBean" method="POST" name="signup" onsubmit="return signup()" class="form-horizontal"  id="signup">
            <div class="form-group">
          <label class="control-label col-sm-3">First Name <span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
            <form:input path="firstName"  class="form-control"  id="mem_name" placeholder="Enter First Name " value=""></form:input>
            <form:errors path="firstName"/><span id="sfname"></span>
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3">Middle Name <span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
            <form:input path="middleName" class="form-control"  id="mem_name" placeholder="Enter Middle Name " value=""></form:input>
          </div>
        </div> 
        <div class="form-group">
          <label class="control-label col-sm-3">Last Name <span class="text-danger">*</span></label>
          <div class="col-md-8 col-sm-9">
            <form:input path="lastName" class="form-control"  id="mem_name" placeholder="Enter Last Name " value=""></form:input>
       ...
       <%-- 
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            ...
            <form:input path="phoneno" class="form-control"  id="contactnum" placeholder="Enter your Primary contact no." value=""></form:input>
