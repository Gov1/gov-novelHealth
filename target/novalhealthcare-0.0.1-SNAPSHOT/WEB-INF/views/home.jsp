		...
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<div class="jumbotron">
					...
					<p>Healthcare was established in 2005, with the mission of providing specialized tertiary medical care services at affordable prices to under
						served communities across the country. This private healthcare provider stands apart from others in its vision of making healthcare for all a
						reality for ordinary people in rural and remote regions. Every single individual working in a hospital- from doctors to nurses and the
						management- is united in the endeavor to deliver top quality healthcare to all. Paras Healthcare is a leader in establishing specialized
						hospitals in places that lack access to healthcare, specifically super specialty tertiary care.
					<p>Paras Hospitals believes in working at the grass root level with patients and their families. The idea is to provide the highest quality
						of healthcare that is affordable and accessible to all.</p>
				</div>
				<div class="row">
